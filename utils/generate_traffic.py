...
from tools import output_folders_data_generator as output_folders
...
def main():
    ...
    try:
        ...
        with open(os.path.join(path, '00_log',  'vehicles.json'), 'w') as file:
            json.dump(vehicles_list, file)
        # -------------
        # Spawn Walkers
        # -------------
        # some settings
        percentagePedestriansRunning = 0.0      # how many pedestrians will run
        percentagePedestriansCrossing = 40.0     # how many pedestrians will walk through the road
        if args.seedw:
